import DisputeDetailsComponentPage from "@components/portal/disputes/details/DisputeDetailsComponentPage";
...
export default function DisputePage() {
  ...
  return (
    <DisputeDetailsComponentPage></DisputeDetailsComponentPage>
  );
}
