...
export function SocialAuthButtons({
  ...
  action = 'sign-in',
  isLoading = false,
  socialAuthHasError = false,
}: SocialAuthButtonsProps) {
  const [processing, setProcessing] = useState<Provider>(null);
  const isProcessing = processing !== null && !socialAuthHasError;
    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        >
          ...
          {processing === 'google' && !socialAuthHasError ? (
        ...
        >
          ...
          {processing === 'apple' && !socialAuthHasError ? (
            <span className="text-sm">Processing...</span>
          ) : (
